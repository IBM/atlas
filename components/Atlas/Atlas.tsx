  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset="0" stop-color="#a8a8a8" stop-opacity=".35" />
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stop-color="#be95ff" stop-opacity=".35" />
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stop-color="#08bdba" stop-opacity=".35" />
          <stop offset="1" stop-color="#0eb7bd" stop-opacity="0" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stop-color="#8541fc" stop-opacity="0" />
          <stop offset="1" stop-color="#8a3ffc" stop-opacity=".35" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0" stop-color="#1366fe" stop-opacity="0" />
          <stop offset="1" stop-color="#0f62fe" stop-opacity=".35" />
        </linearGradient>
        <linearGradient
        ...
        >
          ...
          <stop offset="1" stop-color="#82cfff" stop-opacity=".35" />
        </linearGradient>
      </defs>
      <g id="base">
        <g
        ...
        <Link href="/security">
          <a>
            <text
              ...
              font-size="20"
              transform="translate(718.398 202.988)"
            >
              <tspan x="0" y="0">
                Security
              </tspan>
        ...
        <Link href="/quantum">
          <a>
            <text
              ...
              font-family="IBMPlexSans, 'IBM Plex Sans'"
              font-size="20"
              transform="translate(717.31 459.988)"
            >
              <tspan x="0" y="0">
                Quantum
              </tspan>
        ...
        <Link href="/data">
          <a>
            <text
              ...
              font-family="IBMPlexSans, 'IBM Plex Sans'"
              font-size="20"
              transform="translate(235.339 642.501)"
            >
              <tspan x="0" y="0">
                Data
              </tspan>
        ...
        <Link href="/ai">
          <a>
            <text
              ...
              font-family="IBMPlexSans, 'IBM Plex Sans'"
              font-size="20"
              transform="translate(78.925 202.988)"
            >
              <tspan x="0" y="0">
                AI
              </tspan>
